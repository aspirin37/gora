<template>
  <article class="main-section top-main-block text-center height-full d-flex align-items-center js-scroll-block rapallax-bgs" ref="main-block">
    ...
    <!-- <img class="rapallax-bgs__image rapallax-bgs__image--1" v-bind:style="parallaxPercent" src="@/images/blured-a3.png">
    <img class="rapallax-bgs__image rapallax-bgs__image--2" v-bind:style="parallaxPercent" src="@/images/blured-a3.png">
    <img class="rapallax-bgs__image rapallax-bgs__image--3" v-bind:style="parallaxPercent" src="@/images/blured-a3.png"> -->
